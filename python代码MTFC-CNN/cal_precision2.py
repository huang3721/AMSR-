...
def test():
    ...
    predict_path = 'G:/AMSR_E_Data/test6/T2_mtfc_chazhi/'
    label_path = 'G:/AMSR_E_Data/test6/T2_label/'
    sta_path = 'G:/AMSR_E_Data/test6/result_sta_t2_mtfc_chazhi.xlsx'
    ...
    mask7_path = 'E:/AMSR_E_Data/mask/mask7.tif'
    mask8_path = 'E:/AMSR_E_Data/mask/mask8.tif'
    ...
    for i in range(num):
        ...
        res = (image - label_img) * 200  # 缩放到原影像的DN值范围
        ...
        RMSE = lst_evalu(pred_img, label_img, 200)  #放大到 K
